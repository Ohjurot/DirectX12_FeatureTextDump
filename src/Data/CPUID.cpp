...
bool DxFeatures::Data::CPUID_Factory::queryCpu(CPUID_RESULT* ptrResultStruct){
    ...
    *reinterpret_cast<int*>(vendor + 8) = cpuInfoBufferVar[(0 * 4) + 2];
    ...
    if (ptrResultStruct->vendorString == "GenuineIntel") {
        ptrResultStruct->vendor = DxFeatures::Data::CPU_VENDOR::INTEL;
    }
    else if (ptrResultStruct->vendorString == "AuthenticAMD") {
        ptrResultStruct->vendor = DxFeatures::Data::CPU_VENDOR::AMD;
    }
